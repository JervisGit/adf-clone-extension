...
export class PipelineEditorProvider {
	...
	public addActivity(activityType: string) {
		if (PipelineEditorProvider.currentPanel) {
    ...
    <div class="main-content">
        ...
        <div class="canvas-container">
            <div class="toolbar">
                ...
                <button class="toolbar-button" id="clearBtn">🗑️ Clear</button>
